                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="ms-auto">
                            <LinkContainer to='/filter'>
                                <Nav.Link><FaListUl /> Filter</Nav.Link>
                            </LinkContainer>
                            <LinkContainer to='/recomendation'>
                                <Nav.Link><FaAward /> Recomendation</Nav.Link>
                            </LinkContainer>
                            <LinkContainer to='/sScreen'>
                                <Nav.Link><FaListUl /> Supplier</Nav.Link>
                            </LinkContainer>
                            ...
                            {userInfo ? (
                                <NavDropdown title={userInfo.displayName || userInfo.name || 'User'} id='username'>
